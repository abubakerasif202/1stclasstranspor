...
export function PageHero({ eyebrow, title, copy, image = '/assets/backgrounds/highway-dawn.webp' }: Props) {
  return (
    <section className="road-grid relative isolate overflow-hidden bg-charcoal py-16 text-white sm:py-20">
      ...
      <div className="container-page">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-3 text-4xl font-extrabold leading-[1.02] sm:text-5xl lg:text-6xl">{title}</h1>
